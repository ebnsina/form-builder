    ...
    <div className="px-2 mb-3">
      ...
      <textarea
        ...
        onBlur={(e) => {
          ...
          const isValid = TextAreaFieldFormElement.validate(element, value);
          setHasError(!isValid);
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="mb-3">
          <label className="block text-sm text-slate-600 mb-1" htmlFor="rows">
            Rows
          </label>
          <Controller
            control={control}
          ...
          <span className="block text-xs text-slate-600 mt-2">
            The rows for field. This will represent how many rows of field.
          </span>
        </div>
